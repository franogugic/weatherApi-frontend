    ...
    return (
        <div className="flex h-full min-h-0 flex-col rounded-4xl bg-div p-6">
            <div className="flex items-center justify-between mb-4">
                ...
                <NavLink to={"/settings"} className="cursor-pointer rounded-2xl border-[1px] border-accent-primary px-4 py-1 bg-linear-to-r from-accent-secondary to-accent-primary bg-clip-text text-transparent">Add new locations</NavLink>
            </div>
                ...
                {favoriteLocations.length ? favoriteLocations.map((location) => (
                    ...
                    >
                        <div className="flex min-w-0 items-center gap-3">
                            <Star size={22} className="fill-accent-secondary text-accent-secondary"/>
                    ...
                    <div className="flex min-h-[104px] flex-1 items-center justify-center p-4">
